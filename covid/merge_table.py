...
signal_file = pd.read_table('/data02/home/susan/project/11_UE_RNA/analysis/secrete_protein/new/merge/signalp_out.txt', sep='\s+')
target_file = pd.read_table('/data02/home/susan/project/11_UE_RNA/analysis/secrete_protein/new/merge/target_parsed.txt', sep='\s+', header = None)
...
merged_result1.to_csv('/data02/home/susan/project/11_UE_RNA/analysis/secrete_protein/new/merge/final_merge',index=False, sep='\t', na_rep='N')
